...
.logo {
     ...
     font-size: 48px; /* Large size for logo */
   ...
   .logo:hover {
     ...
     color: #e67e22; /* Bright color on hover */
   }

   /* Optional container for logo alignment in navbar */
   .logo-container {
     display: flex;
     align-items: center;
   }

   /* Logo icon (if you want to add an image) */
   .logo-icon {
     height: 50px;
     margin-right: 10px;
   }
 </style><link href="https://fonts.googleapis.com/css2?family=Great+Vibes&display=swap" rel="stylesheet">
<head>
    <meta charset="utf-8">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src=" " alt=""> <h1 class="logo">Nihal Cafee</h1></a>
